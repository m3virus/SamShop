    ...
    public partial class data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, null, "d0b465bb-680b-4914-bf0d-1e1c6f46be94", null, "m3virus@mail.com", true, "Mohammadhasan", false, "Yazdani", false, null, null, "M3VIRUS", "AQAAAAIAAYagAAAAEB3b7AqrI52yT0TbIq3J3GKSr6PztDm2xaCZ1NULXFPFTyf5jjQc1dG6yg9+TaEJ5g==", "0912345678", true, new DateTime(2023, 11, 19, 14, 56, 42, 422, DateTimeKind.Local).AddTicks(8102), "c051d023-b58c-40ba-8e8b-1b423d53ccb4", false, "M3Virus" },
                    { 2, 0, null, "cf9f90cc-7a31-4f00-8fdc-82c045d2fa2f", null, "Customer2@mail.com", true, "cust", false, "omer", false, null, null, "CUSTOMER1", "AQAAAAIAAYagAAAAEOcwyAGaDVF9YA2eY7CLM8795ATFNwlr2DzN5was1ZQ2lMAd0yEXX+6mZcbl3B90Sg==", "0912345678", true, new DateTime(2023, 11, 19, 14, 56, 42, 422, DateTimeKind.Local).AddTicks(8174), "dcff0c91-726a-4f76-82ef-30134eff11be", false, "customer1" },
                    { 3, 0, null, "a5d6ce06-be6b-484f-a9e6-66a41c15410a", null, "Customer2@mail.com", true, "cust", false, "omer", false, null, null, "CUSTOMER2", "AQAAAAIAAYagAAAAEEPav5ozMA5r3nTabOFIRBKazE6e2Vcd85cWM3BbvQ8WK5hONGgg01cty1FjZ8W5YQ==", "0912345678", true, new DateTime(2023, 11, 19, 14, 56, 42, 422, DateTimeKind.Local).AddTicks(8209), "087d5826-d563-4922-850f-3497e0e99922", false, "customer2" },
                    { 4, 0, null, "f5d24a63-5605-41db-9db2-a4951e127ec9", null, "Seller1@mail.com", true, "sel", false, "ler", false, null, null, "Seller1", "AQAAAAIAAYagAAAAEKF7eVx9QGlB2RR/ATwblpZ5GjrDCjZHCj9vBO3VW707AfnGfzmkkJnnoFIFu/6FrA==", "0912345678", true, new DateTime(2023, 11, 19, 14, 56, 42, 422, DateTimeKind.Local).AddTicks(8226), "1090e8c4-bc28-49bb-9e8b-9ba2d9decc53", false, "Seller1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "category 1", new DateTime(2023, 11, 19, 14, 56, 42, 816, DateTimeKind.Local).AddTicks(338), null, true, false },
                    { 2, "category 2", new DateTime(2023, 11, 19, 14, 56, 42, 816, DateTimeKind.Local).AddTicks(364), null, true, false }
                });

            migrationBuilder.InsertData(
                table: "Medals",
                columns: new[] { "MedalId", "CreateTime", "DeleteTime", "IsDeleted", "MedalType", "WagePercentage" },
                values: new object[] { 1, new DateTime(2023, 11, 19, 14, 56, 42, 816, DateTimeKind.Local).AddTicks(4233), null, false, "Medal 1", 4m });

            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "AdminId", "AddressId", "AppUserId", "CreateTime", "DeleteTime", "IsDeleted", "PictureId", "Wallet" },
                values: new object[] { 1, 1, 1, new DateTime(2023, 11, 19, 14, 56, 42, 814, DateTimeKind.Local).AddTicks(5150), null, false, null, 100m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5, "booth 1", new DateTime(2023, 11, 19, 14, 56, 42, 815, DateTimeKind.Local).AddTicks(4580), null, false },
                    { 2, 6, "booth 2", new DateTime(2023, 11, 19, 14, 56, 42, 815, DateTimeKind.Local).AddTicks(4588), null, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, new DateTime(2023, 11, 19, 14, 56, 42, 815, DateTimeKind.Local).AddTicks(7524), null, false, null, 10m },
                    { 2, 3, new DateTime(2023, 11, 19, 14, 56, 42, 815, DateTimeKind.Local).AddTicks(7536), null, false, null, 20m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 11, 19, 14, 56, 42, 815, DateTimeKind.Local).AddTicks(8918), 1, false, false, 0m },
                    { 2, null, new DateTime(2023, 11, 19, 14, 56, 42, 815, DateTimeKind.Local).AddTicks(8923), 2, false, false, 0m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 19, 14, 56, 42, 817, DateTimeKind.Local).AddTicks(1330), 5, 1, 1, null, false, true, false, 6m, "Product 1" },
                    { 2, new DateTime(2023, 11, 19, 14, 56, 42, 817, DateTimeKind.Local).AddTicks(1341), 5, 2, 2, null, false, true, false, 12m, "Product 2" }
                });

            migrationBuilder.InsertData(
                table: "Sellers",
                columns: new[] { "SellerId", "AddressId", "AppUserId", "BoothId", "CreateTime", "DeleteTime", "IsDeleted", "MedalId", "PictureId", "Wallet" },
                values: new object[] { 1, 4, 4, 1, new DateTime(2023, 11, 19, 14, 56, 42, 817, DateTimeKind.Local).AddTicks(9900), null, false, 1, null, 100m });

            migrationBuilder.InsertData(
                table: "Auctions",
                columns: new[] { "AuctionId", "AuctionTitle", "CancelTime", "EndTime", "IsAccepted", "IsCanceled", "ProductId", "SellerId", "StartTime", "TheLowestOffer" },
                values: new object[] { 1, "AuctionSample 1", null, new DateTime(2023, 11, 19, 0, 0, 0, 0, DateTimeKind.Local), false, false, 1, 1, new DateTime(2023, 11, 19, 14, 56, 42, 814, DateTimeKind.Local).AddTicks(653), 10m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, null, false, new DateTime(2023, 11, 19, 14, 56, 42, 818, DateTimeKind.Local).AddTicks(3503), 4m, 1, 1 });
